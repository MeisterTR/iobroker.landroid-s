...
LandroidCloud.prototype.sendMessage = function (message) {
  ...
  this.adapter.log.info('Sending Message: ' + message);
  //var sends = '{"cmd":3}';
...
LandroidCloud.prototype.onMessage = function (payload) {
  ...
  if(data) {
    ...
    this.adapter.log.info("Landroid status: " + JSON.stringify(status));
    ...
    this.adapter.log.info("No 'dat' in message payload! " + JSON.stringify(payload));
};
