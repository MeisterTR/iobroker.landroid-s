...
function evaluateResponse() {
  adapter.setState("lastsync", {
    val: new Date().toISOString(),
    ack: true
  });
  adapter.setState("firmware", {
    val: data.dat.fw,
    ack: true
  });
  ...
  adapter.setState("mower.waitRain", {
    val: data.cfg.rd,
    ack: true
  });
  adapter.setState("mower.batteryState", {
    val: data.dat.bt.p,
    ack: true
  });
  adapter.setState("mower.areasUse", {
    val: (data.cfg.mz[0] + data.cfg.mz[1] + data.cfg.mz[2] + data.cfg.mz[3]),
    ack: true
  });
